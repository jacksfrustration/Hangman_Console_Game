...
class Words:
    ...
    def __init__(self):
        self.words=('''abruptly absurd abyss affix askew avenue awkward axiom azure bagpipes bandwagon banjo 
    ...
    glowworm glyph gnarly gnostic gossip grogginess haiku haphazard hyphen iatrogenic icebox injury
    ivory ivy jackpot jaundice jawbreaker jaywalk jazziest jazzy jelly jigsaw jinx jiujitsu jockey
    jogging joking jovial joyful juicy jukebox jumbo kayak kazoo keyhole khaki kilobyte kiosk kitsch
    kiwifruit klutz knapsack larynx lengths lucky luxury lymph marquis matrix megahertz microwave
    mnemonic mystify naphtha nightclub nowadays numbskull nymph onyx ovary oxidize oxygen pajama
    ...
    xylophone yachtsman yippee yoked youthful yummy zephyr zigzag zigzagging zilch zipper zodiac zombie''' ).split()
        self.chosen_word=self.choose_a_word()
